...
class RestControllerSecurityTest {
    ...
    public static Stream<Arguments> getTestData() throws JsonProcessingException {
        ...
        return Stream.of(
                ...
                Arguments.of("post", "/api/authors", "USER", roles,403, false),
                Arguments.of("post", "/api/authors", "ADMIN", adminRoles,400, false),

                Arguments.of("put", "/api/authors", null, null,302, true),
                Arguments.of("put", "/api/authors", "USER", roles,403, false),
                Arguments.of("put", "/api/authors", "ADMIN", adminRoles,400, false),

                Arguments.of("delete", "/api/authors/1", null, null,302, true),
                Arguments.of("delete", "/api/authors/1", "USER", roles,403, false),
                Arguments.of("delete", "/api/authors/1", "ADMIN", adminRoles,200, false),
                ...
                Arguments.of("get", "/api/authors", "USER", roles,403, false),
                Arguments.of("get", "/api/authors", "ADMIN", adminRoles,200, false),
                Arguments.of("get", "/api/authors/1", "USER", roles,403, false),
                Arguments.of("get", "/api/authors/1", "ADMIN", adminRoles,200, false)
